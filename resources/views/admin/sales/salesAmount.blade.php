...
@section('content')
  ...
  <style>
    ...
    table {
      width: 100%;
      border-collapse: collapse; /* セルの間のボーダーを消す */
      margin-top: 20px;
      font-size: 16px;
      white-space: nowrap;
    }
    ...
    td {
      padding: 12px;
      border-bottom: 1px solid #dee2e6; /* 薄い下線 */
    }
    ...
    /* ホバー時のスタイル */
    tr:hover {
      background-color: #e9ecef; /* 薄いグレーの背景色 */
    }
    ...
    tr:nth-child(even) {
      background-color: #f2f2f2; /* より薄いグレー */
    }
