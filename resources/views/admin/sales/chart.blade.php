    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (itemCategorySummary.length > 0) {
                ...
                var categoryPieData = itemCategorySummary.map(summary => parseFloat(summary
                .total_category_amount)); //数値で表示
                ...
                var categoryPieChart = new Chart(categoryPieCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            backgroundColor: backgroundColors.slice(0, categoryPieLabels
                            .length), // データ数に合わせて色を適用
                            ...
                            tooltip: {
                                callbacks: {
                                    label: function(tooltipItem) {
                                        ...
                                        label += '¥' + number_format(value) + ' (' + percentage +
                                        ')'; //金額と％両方表示
