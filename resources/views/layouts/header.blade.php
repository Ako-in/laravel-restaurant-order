<header
    style="background-image: url('{{ asset('storage/images/top2.jpg') }}'); 
  ...
  background-color: rgba(0, 0, 0,0.4);">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark w-100" style="position: relative; z-index: 2;">
        {{-- <img src="{{Storage::url('public/images/toppage.jpg')}}" alt="" style="max-height: 60px;"> --}}
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <a href="{{ route('customer.menus.index') }}"
                            class="nav-link text-white me-3 fw-bold">メニュー一覧</a>
                        ...
                        <a href="{{ route('customer.carts.checkout') }}"
                            class="nav-link text-white me-3 fw-bold">注文履歴・決済画面</a>
